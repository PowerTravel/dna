...
//	m["SIZE"] = UNSIGNED_INTEGER_TYPE;
	...
	// Distance
	m["COLLISION_GRID_BOX_SIZE"] =	DOUBLE_TYPE;
	m["CHAIN_LENGTH"] =	UNSIGNED_INTEGER_TYPE;
	m["CHAIN_RADIUS"] = DOUBLE_TYPE;
	//m["PARTICLE_RADIUS"] = DOUBLE_TYPE;
	m["PARTICLE_RADIUS_MAX"] = DOUBLE_TYPE;
	m["PARTICLE_RADIUS_MIN"] = DOUBLE_TYPE;
	m["PARTICLE_RADIUS_STEP"] = UNSIGNED_INTEGER_TYPE;
	m["SIMULATION_TIME"] = DOUBLE_TYPE;
	m["DELTA_TIME"] = DOUBLE_TYPE;
//	m["STRIDES"] = UNSIGNED_INTEGER_TYPE;
//	m["SAMPLES"]= UNSIGNED_INTEGER_TYPE;
//	m["EXP"] = BOOL_TYPE;
